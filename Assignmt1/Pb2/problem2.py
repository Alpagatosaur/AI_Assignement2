...
path_lib = os.path.join(path_project, "lib_rec")

PATH_CCNAMES = os.path.join(path_lib, YOLOV3_PATH, "data", "coco.names")
PATH_YOLOV3_TINY_CFG = os.path.join(path_lib, YOLOV3_PATH, "cfg", "yolov3-tiny.cfg")
PATH_YOLOV3_TINY_WEIGHTS = os.path.join(path_lib, YOLOV3_PATH, "yolov3-tiny.weights")
